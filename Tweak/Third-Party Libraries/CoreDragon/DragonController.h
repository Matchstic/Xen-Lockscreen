...
@interface DragonControllerModified : NSObject
...
-(void)beganDragOperation:(id<DragonInfo>)drag fromView:(UIView*)draggable;
...
- (void)dropTarget:(UIView*)droppable acceptDrag:(id<DragonInfo>)drag atPoint:(CGPoint)p withProxyView:(UIView*)proxy;
