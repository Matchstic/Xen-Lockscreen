...
@interface XENLaunchpadDataSource : NSObject {
    NSMutableDictionary *cachedZoomViews;
    NSMutableDictionary *cachedZoomViewsLandscapeLeft;
    NSMutableDictionary *cachedZoomViewsLandscapeRight;
    NSMutableDictionary *cachedZoomViewsUpsideDown;
    
    NSMutableDictionary *cachedIdentifiersToPaths;
}
