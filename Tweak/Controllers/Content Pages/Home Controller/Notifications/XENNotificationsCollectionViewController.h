...
@interface XENNotificationsCollectionViewController : UICollectionViewController <UICollectionViewDelegate, UIScrollViewDelegate>
...
-(void)relayoutForChangeInDataSource:(BOOL)isAddingItem andIndex:(int)index;
