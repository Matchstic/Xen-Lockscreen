...
#import "XENSetupMultipleSwitchCell.h"

@implementation XENSetupMultipleSwitchCell
...
-(instancetype)initWithImage:(UIImage *)image label:(NSString *)label node:(int)node andDelegate:(id)delegate {
    ...
    if (self) {
        ...
        _label.textColor = _imageView.tintColor; //[[UIApplication sharedApplication] keyWindow].tintColor;
        _label.layer.borderColor = _imageView.tintColor.CGColor; //[[UIApplication sharedApplication] keyWindow].tintColor.CGColor;
        [_label sizeToFit];
