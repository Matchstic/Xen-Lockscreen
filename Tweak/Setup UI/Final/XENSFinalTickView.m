...
@implementation XENSFinalTickView
...
-(instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        UIImage *tick = [UIImage imageWithContentsOfFile:[NSString stringWithFormat:@"/Library/PreferenceBundles/XenPrefs.bundle/Tick%@", [XENResources imageSuffix]]];
