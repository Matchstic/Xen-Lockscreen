...
#import "XENPWelcomeController.h"
#import "XENPResources.h"

@interface XENPWelcomeController ()

@end

@implementation XENPWelcomeController

-(id)specifiers {
    if (_specifiers == nil) {
        NSMutableArray *testingSpecs = [self loadSpecifiersFromPlistName:@"Welcome" target:self];
