...
#import "XENPWidgetsController.h"
#import "XENPResources.h"

@interface XENPWidgetsController ()

@end

@implementation XENPWidgetsController

-(id)specifiers {
    if (_specifiers == nil) {
        NSMutableArray *testingSpecs = [self loadSpecifiersFromPlistName:@"NCWidgets" target:self];
